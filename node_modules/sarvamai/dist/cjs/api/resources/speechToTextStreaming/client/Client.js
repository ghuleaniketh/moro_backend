...
exports.SpeechToTextStreaming = void 0;
...
class SpeechToTextStreaming {
    ...
    connect() {
        return __awaiter(this, arguments, void 0, function* (args = {}) {
            var _a, _b, _c, _d, _e;
            const queryParams = {};
            if (args["language-code"] != null) {
                queryParams["language-code"] = args["language-code"];
            }
            if (args["model"] != null) {
                queryParams["model"] = args["model"];
            }
            if (args["input_audio_codec"] != null) {
                queryParams["input_audio_codec"] = args["input_audio_codec"];
            }
            if (args["sample_rate"] != null) {
                queryParams["sample_rate"] = args["sample_rate"].toString();
            }
            if (args["flush_signal"] != null) {
                queryParams["flush_signal"] = args["flush_signal"];
            }
