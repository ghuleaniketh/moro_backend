...
class TextToSpeechStreamingSocket {
     ...
     */
    configureConnection({ target_language_code, speaker = "anushka", pitch = 0.0, pace = 1.0, loudness = 1.0, speech_sample_rate = 22050, enable_preprocessing = false, output_audio_codec = "mp3", output_audio_bitrate = "128k", min_buffer_size = 50, max_chunk_length = 150, }) {
