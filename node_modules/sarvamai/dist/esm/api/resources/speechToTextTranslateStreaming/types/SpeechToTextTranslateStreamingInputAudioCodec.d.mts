 ...
 */
export type SpeechToTextTranslateStreamingInputAudioCodec = "wav" | "x-wav" | "wave" | "mp3" | "mpeg" | "mpeg3" | "x-mp3" | "x-mpeg-3" | "aac" | "x-aac" | "aiff" | "x-aiff" | "ogg" | "opus" | "flac" | "x-flac" | "mp4" | "x-m4a" | "amr" | "x-ms-wma" | "webm" | "pcm_s16le" | "pcm_l16" | "pcm_raw";
export declare const SpeechToTextTranslateStreamingInputAudioCodec: {
    readonly Wav: "wav";
    readonly XWav: "x-wav";
    readonly Wave: "wave";
    readonly Mp3: "mp3";
